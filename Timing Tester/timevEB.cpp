...
int main()
{
    Van_Emde_Boas* VebTree = new Van_Emde_Boas(625000);//Clean square root

  //To start out, have 30k unique IDS in the database
    for (int i = 0; i <= 500000; i++)
    {
        insert(VebTree, i);
    }

    if (isMember(VebTree, 250001))
    {
        cout << endl << "Found";
    }

    //Insert Linked list finding last element below vvvv
